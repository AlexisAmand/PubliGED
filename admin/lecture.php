...
<head>
	...
	<title><?php echo SITE_TITLE." - ".ASIDE_ADMIN_0; ?></title>
...
<div style="witdh: 100%; height: 20px; border: 0px solid black;">
	...
	<img src="../img/arrow.png" alt="" /> <a href="index.php"><?php echo ASIDE_ADMIN_2; ?></a>
	<img src="../img/arrow.png" alt="" /> <a href="biblio_ono.php.php"><?php echo TITRE_RUB_ADMIN_3; ?></a>
	</span>
</div>
...
while ( ! feof ( $gedcom ) ) 
	...
	*/
	...
	if (preg_match ( "/1 CHIL/", $ligne )) 
	   ...
	   /* si le couple a déjà un enfant alors la ligne est dupliquée et j'ajoute le nouvel enfant */
	       {
...
<table id='EveT'>
    <tr>
		<td>Nom du logiciel</td><td>TODO</td>
	</tr>
    <tr>
		<td>Nom complet du logiciel</td><td>TODO</td>
	</tr>
	<tr>
		<td>Auteur du fichier</td><td><?php echo $uploader->name; ?></td>
	</tr>
	<tr>
		<td>Adresse de l'auteur</td><td><?php echo $uploader->adresse; ?></td>
	</tr>
	<tr>
		<td>email de l'auteur</td><td><?php echo $uploader->mail; ?></td>
	</tr>
	<tr>
		<td>site de l'auteur</td><td><?php echo $uploader->www; ?></td>
	</tr>
</table>
...
<table id='EveT'>
    <tr>
		<td>Nombre d'événements importés</td><td><?php echo $nb_eve; ?></td>
	</tr>
    <tr>
		<td>Nombre d'individus importés</td><td><?php echo $nb_individu; ?></td>
	</tr>
	<tr>
		<td>Nombre de lieux importés</td><td><?php echo $nb_lieu; ?></td>
	</tr>
	<tr>
		<td>Nombre de sources importées</td><td><?php echo $nb_source; ?></td>
	</tr>
	<tr>
		<td>Nombre de medias importés</td><td><?php echo $nb_media; ?></td>
	</tr>
	<tr>
		<td>Nombre de familles importées</td><td><?php echo $nb_famille; ?></td>
	</tr>
</table>	
	
</div>

<?php include('include/endheader.php'); /* 786 */  ?>