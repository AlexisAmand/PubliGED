...
<label for=" ">Activer le blog</label>
<input type="checkbox" id=" " name=" " value=" ">

<br />

<label for=" ">Activer le partie généalogie</label>
<input type="checkbox" id=" " name=" " value=" ">
...
<label>Nombre de resultats par pages</label>
<input type="text" value="12" name="nrpp">

<br />

<label>Valeur des tops</label>
...
<label for="subscribeNews">Activer les commentaires</label>
<input type="checkbox" id=" " name=" " value=" ">
