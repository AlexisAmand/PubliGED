...
<table border="0" id="Tree">
	...
	<tr style="height: 16px;">
	    <td style="border-right:1px solid #6B6B6B;"></td>
	    <td style="border-left:1px solid #6B6B6B;border-bottom:1px solid #6b6b6b;"></td>
	    <td style="border-bottom:1px solid #6b6b6b;"></td>
	    <td style="border-bottom:1px solid #6b6b6b;"></td>
	    <td style="border-right:1px solid #6B6B6B;border-bottom:1px solid #6b6b6b;"></td>
	    <td style="border-left:1px solid #6B6B6B;"></td>
	    <td></td>
	   	<td></td>
	    <td style="border-right:1px solid #6B6B6B;"></td>
	    <td style="border-left:1px solid #6B6B6B;border-bottom:1px solid #6b6b6b;"></td>
	...
	<tr style="height: 16px;">
	    <td colspan="3" style="border-right:1px solid #6B6B6B;"></td>
	    <td colspan="8" ></td>
	    <td colspan="3" style="border-left:1px solid #6B6B6B;"></td>
	</tr>	
	<tr>
	    <td colspan="2"></td>
	    <td colspan="2" style="text-align:center">
	...
	<tr style="height: 16px;">
	    <td colspan="3" style="border-right:1px solid #6b6b6b;"></td>
	    <td colspan="8" style="border-bottom:1px solid #6b6b6b;"></td>
	    <td colspan="3" style="border-left:1px solid #6b6b6b;"></td>
	</tr>
	<tr style="height: 16px;">
	    <td colspan="7" style="border-right:1px solid #6b6b6b;"></td>
	    <td colspan="7" style="border-left:1px solid #6b6b6b;"></td>
	</tr>
	    <tr>
	    <td colspan="6"></td>
	    <td colspan="2" style="text-align:center">
