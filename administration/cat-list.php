                  	...
                  	while ($data = $req->fetch(PDO::FETCH_ASSOC))
                    	{
                      	...
                      	echo "<td>" . $data ['ref'] . "</td>";
                      	echo "<td>" . $data ['nom'] . "</td>";
                      	echo '<td class="text-center"><a href="cat-edit.php?cat='.$data['ref'].'" data-toggle="tooltip" data-placement="left" title="Editer"><i class="far fa-edit text-success"></i></a></td>';
