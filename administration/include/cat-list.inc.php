...
<div class="modal fade" id="PublishCat" tabindex="-1" role="dialog" aria-labelledby="PublishCatLabel" aria-hidden="true">
	...
	<div class="modal-content">
		<div class="modal-header">
		<h5 class="modal-title" id="PublishCatLabel"><?php echo "publier une catégorie"; ?></h5>
		<button class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
			<span aria-hidden="true">×</span>
		</button>
		</div>
...
<div class="modal fade" id="UnPublishCat" tabindex="-1" role="dialog" aria-labelledby="UnPublishCatLabel" aria-hidden="true">
	...
	<div class="modal-content">
		<div class="modal-header">
		<h5 class="modal-title" id="UnPublishCatLabel"><?php echo "dépublier une catégorie"; ?></h5>
		<button class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
			<span aria-hidden="true">×</span>
		</button>
		</div>
...
modalBodyInput.textContent = "Etes-vous sûr de vouloir supprimer la catégorie n°" + recipient + " ?"
