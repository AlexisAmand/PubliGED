<div class="container-fluid px-4">
    ...
    <h1 class="h3 mt-4"><?php echo HELLO." ".$_SESSION['login']; ?>.</h1>  
		...
		<ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page"><?php echo "Activité de l'utilisateur" ?></li>
		</ol>
        	...
        	<div class="col-xl-12">
				<div class="card mb-4">
					<div class="card-header">
                        <i class="bi bi-people me-2"></i><?php echo "Activité de l'utilisateur" ?>
					</div>
					<div class="card-body">
										    										    
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
					    	<button class="nav-link active" id="blog-tab" data-bs-toggle="tab" data-bs-target="#blog" type="button" role="tab" aria-controls="blog" aria-selected="true">blog</button>
					  	</li>
					  	<li class="nav-item" role="presentation">
					    	<button class="nav-link" id="genealogie-tab" data-bs-toggle="tab" data-bs-target="#genealogie" type="button" role="tab" aria-controls="genealogie" aria-selected="false">genealogie</button>
					  	</li>
					</ul>
						...
						<div class="tab-content" id="myTabContent">
							...
							?>
								...
								<div class="d-grid d-md-flex justify-content-md-end mt-3">
									<a href="<?php echo "logs/blog.zip"; ?>" type="submit" name="envoyer" class="btn btn-sm btn-secondary"><?php echo "Télécharger le fichier"; ?></a>
								</div>
							...
							?>
								...
								<div class="d-grid d-md-flex justify-content-md-end mt-3">
									<a href="<?php echo "logs/genealogie.zip"; ?>" type="submit" name="envoyer" class="btn btn-sm btn-secondary"><?php echo "Télécharger le fichier"; ?></a>
								</div>
